class Config(object):
    ...
    TOKEN = "7376926690:AAHMrG2af_g0k23r9SfJmSN22puLy1MNUKg"
    ...
    SUPPORT_CHAT = "CATCH_YOUR_WH_UPDATES"
    UPDATE_CHAT =  "Catch_Your_WH_Group"
    BOT_USERNAME = "@Catch_Your_Husbando_Bot"
